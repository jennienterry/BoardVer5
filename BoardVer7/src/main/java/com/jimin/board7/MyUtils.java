...
import com.jimin.board7.user.UserEntity;
...
public class MyUtils {			
	...
	public static int getLoginUserPk(HttpServletRequest request) {
		UserEntity vo = getLoginUser(request);
		return vo.getIuser();
//		return (UserEntity)getLoginUser(request).getIuser();
	}
	...
	public static void openJSP(String title, String jsp, HttpServletRequest request, HttpServletResponse response)
		...
		request.setAttribute("page", jsp);	
		String template = "/WEB-INF/view/template.jsp";
